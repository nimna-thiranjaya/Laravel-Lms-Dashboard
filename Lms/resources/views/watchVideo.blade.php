...
<section class="watch-video">
    ...
    <div class="video-container">
       <div class="video">
          <video src="{{asset('admin/dist/images/vid-1.mp4')}}" controls poster="{{asset('admin/dist/images/post-1-1.png')}}" id="video"></video>
       </div>
 ...
 <section class="comments">
    ...
    <div class="box-container">
       ...
       <div class="box">
          <div class="user">
             <img src="{{asset('admin/dist/images/pic-1.jpg')}}" alt="">
             <div>
                <h3>shaikh anas</h3>
       ...
       <div class="box">
          <div class="user">
             <img src="{{asset('admin/dist/images/pic-4.jpg')}}" alt="">
             <div>
                <h3>john deo</h3>
                <span>22-10-2022</span>
             </div>
